...
<meta property="og:url" content="https://www.canakkale-drone.com.tr">
<meta property="og:locale" content="tr_TR">
<meta property="og:site_name" content="Çanakkale Drone Çekimi">

<meta name="robots" content="index, follow">
<link rel="canonical" href="https://www.canakkale-drone.com.tr">
...
"image": "https://www.canakkale-drone.com.tr/favicon.png",
"@id": "https://www.canakkale-drone.com.tr",
"url": "https://www.canakkale-drone.com.tr",
...
<button class="px-4 py-2 text-foreground hover-elevate active-elevate-2 rounded-md transition-colors" data-testid="link-nav-services" title="Çözümlerimiz - Çanakkale Drone Çekimi">Çözümlerimiz</button>
...
<button class="inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover-elevate active-elevate-2 bg-primary text-primary-foreground border border-primary-border min-h-8 rounded-md px-3 text-xs" data-testid="button-header-quote" title="Fiyat Teklifi - Çanakkale Drone Çekimi">
...
<div>
<h3 class="font-semibold mb-1 text-foreground">Adres Bilgisi</h3>
<p class="text-sm text-muted-foreground">Esenler Mh. Ahmet Piriştina Cd. <br>No:19 Daire:17 <br>Çanakkale 17000 </p>
</div>
</div>
</div>
</div>
...
<div>
<h3 class="font-semibold mb-1 text-foreground">Telefon Hattı</h3>
<a href="tel:+905347922531" class="text-sm text-primary hover:underline" data-testid="link-contact-phone" title="Drone Çekimi Telefon">+90 534 792 25 31</a>
</div>
</div>
</div>
</div>
...
<div>
<h3 class="font-semibold mb-1 text-foreground">E-posta Adresi</h3>
<a href="mailto:info@cozumcloud.com.tr" class="text-sm text-primary hover:underline" data-testid="link-contact-email" title="Drone Çekimi E-posta">info@cozumcloud.com.tr</a>
</div>
</div>
</div>
</div>
...
<div>
<h3 class="font-semibold mb-1 text-foreground">Mesai Saatleri</h3>
<p class="text-sm text-muted-foreground">Pazartesi - Cuma: 09:00 - 18:00 <br>Hafta Sonu: Randevu ile </p>
</div>
</div>
</div>
</div>
...
<a href="#" class="text-muted-foreground hover:text-primary transition-colors p-2 hover-elevate active-elevate-2 rounded-md" aria-label="Twitter" data-testid="link-social-twitter" title="Drone Çekimi Twitter">
